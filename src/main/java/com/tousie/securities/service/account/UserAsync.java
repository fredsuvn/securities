...
public class UserAsync {
    ...
    public void senMessageForPhone(String phone) {
        try {
            ...
            //替换成你的AK
            final String accessKeyId = "LTAI59JigVFzwGEY";//你的accessKeyId,参考本文档步骤2
            final String accessKeySecret = "j3vH82Mz9WSOEXQ6JYuo1YiCGsTvx2";//你的accessKeySecret，参考本文档步骤2
            ...
            request.setTemplateCode("SMS_144942552");
            //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
            //友情提示:如果JSON中需要带换行符,请参照标准的JSON协议对换行符的要求,比如短信内容中包含\r\n的情况在JSON中需要表示成\\r\\n,否则会导致JSON在服务端解析失败
            request.setTemplateParam("{\"code\":\"duziele\"}");
